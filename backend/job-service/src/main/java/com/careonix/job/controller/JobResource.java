...
public class JobResource {
    ...
    @DeleteMapping("/by-recruiter")
    public ResponseEntity<Map<String, String>> deleteJobsByRecruiter(@RequestParam("email") String email) {
        log.info("REST request to delete jobs by recruiter email: {}", email);
        return ResponseEntity.ok(Map.of("message", "Jobs deleted for recruiter: " + email));
    }
}
